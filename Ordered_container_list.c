...
int OC_deallocate_item(struct Ordered_container* c_ptr, void* item_ptr, OC_comp_fp_t comp_func, const void* arg_ptr)
{
	free((LL_Node*)item_ptr);
	return 0;
}

/* Insert node after given node */
void OC_insert_after(struct Ordered_container* c_ptr, void* item_ptr, const void* data_ptr)
{
	struct LL_Node *node_ptr = (LL_Node*)item_ptr;
	struct LL_Node *new_node = (LL_Node*)malloc(sizeof(LL_Node));
...
void OC_insert_before(struct Ordered_container* c_ptr, void* item_ptr, const void* data_ptr)
{
	struct LL_Node *node_ptr = (LL_Node*)item_ptr;
	struct LL_Node *new_node = (LL_Node*)malloc(sizeof(LL_Node));
...
int OC_check_and_delete(struct Ordered_container* c_ptr, void* item_ptr, OC_comp_fp_t comp_func, const void* arg_ptr)
{
...
int OC_check_and_insert(struct Ordered_container* c_ptr, void* item_ptr, OC_comp_fp_t comp_func, const void* arg_ptr)
{
	if (comp_func(OC_get_data_ptr(item_ptr), arg_ptr) >= 0)
	{
...
int OC_check_and_find(struct Ordered_container* c_ptr, void* item_ptr, OC_comp_fp_t comp_func, const void* arg_ptr)
{
	if (comp_func(OC_get_data_ptr(item_ptr), arg_ptr) == 0)
	{
		return (int)item_ptr;
...
void OC_initialize_node(struct LL_Node* node_ptr, struct LL_Node* prev, struct LL_Node* next, const void* data_ptr)
{
	node_ptr->prev = prev;
	node_ptr->next = next;
...
int OC_apply_helper(const struct Ordered_container* c_ptr, void* afp, void* arg_ptr, apply_enum apply_func, OC_comp_fp_t comp_func)
{
